package com.gcaa.fplmb.tcp.model.icao;

import java.io.Serializable;
import java.util.Date;

public class IcaoAftnMessage implements Serializable{
	
 	/**
	 * 
	 */
	private static final long serialVersionUID = -909610170064292119L;
